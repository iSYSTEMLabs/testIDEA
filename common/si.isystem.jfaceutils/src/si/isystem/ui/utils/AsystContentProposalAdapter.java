...
// *     Hannes Erven <hannes@erven.at> - Bug 293841 - [FieldAssist] NumLock keyDown 
// *                        event should not close the proposal popup [with patch]
// *     Asystelectronic - updated to compile in this project, see next rev. for real changes
// *     Asystelectronic - pop-up no longer closes if user continues typing after pressing
// *                       content-assist hot key. For example, original impl. of this class
// *                       user pressed Ctrl-Space and pop-up opened. When user pressed next
// *                       char, pop-up closed instead of being updated. This was due to
// *                       autoactivation chars specified. 
// *     Asystelectronic - autoactivation in case of TAB key was disabled. This way pop-up
// *                       no longer appeared when focus changed                  
// *******************************************************************************/
//
...
//
///**
// * @deprecated both asyst modifications were made obsolete by specifying all
// * alpha auto-activation chars in ctor. Also in KTable this class is not 
// * available, as KTable has no access to AsystJFaceUtils.
// * 
// * ContentProposalAdapter can be used to attach content proposal behavior to a
// * control. This behavior includes obtaining proposals, opening a pop-up dialog,
// * managing the content of the control relative to the selections in the pop-up,
// * and optionally opening up a secondary pop-up to further describe proposals.
// * <p>
// * A number of configurable options are provided to determine how the control
// * content is altered when a proposal is chosen, how the content proposal pop-up
...
// * control the pop-up. However, most of the implementation remains private.
// *
// * Asyst modification:
// * Pop-up no longer closes if user continues typing after pressing
// *                       content-assist hot key. For example, original impl. of this class
// *                       user pressed Ctrl-Space and pop-up opened. When user pressed next
// *                       char, pop-up closed instead of being updated. This was due to
// *                       auto-activation chars specified.
// * 
// *  Auto-activation of completion pop-up in case of TAB key was disabled. This way pop-up
// *  no longer appeared when focus changed.                  
// */
//public class AsystContentProposalAdapter {
//
//    /*
//     * The lightweight pop-up used to show content proposals for a text field. If
...
//    public AsystContentProposalAdapter(Control control,
...
//     */
//    public void addContentProposalListener(IAsystContentProposalListener2 listener) {
...
//     * @see org.eclipse.jface.fieldassist.IContentProposalListener2
//     */
//    public void removeContentProposalListener(IAsystContentProposalListener2 listener) {
...
//                                // Escape and Enter keys should not trigger pop-up, as
//                                // it pops up when TAB is pressed after Esc closing
//                                // the proposals pop-up, for example: if this condition is missing,
//                                // press a key which pops-up content proposals in text control,
//                                // then press Esc to close the pop-up, then press TAB to
//                                // jump to another control - proposals pop-up opens, which is WRONG!
//                                e.character != SWT.ESC  &&  e.character != SWT.CR  &&  e.character != SWT.TAB) {
//                            
//                            watchModify = true;
//                            // System.out.println("--- W Modify 3 --- " + (int)e.character);
//                        }
//
//                        return;
//                    }
...
//        for (int i = 0; i < listenerArray.length; i++) {
//            ((IAsystContentProposalListener2) listenerArray[i])
...
//        /*
//         * This method was commented out, so that once the user opens proposals
//         * pop-up, it remains opened also on subsequent key presses. For example,
//         * if activation keystroke and char are defined in ctor, and user presses
//         * activation keystroke (for example Ctrl+Space), proposals pop-up opens.
//         * However, if user then presses any key, pop-up should remain opened,
//         * is is the case now. Before this comment proposlas closed :-(
//         * 
