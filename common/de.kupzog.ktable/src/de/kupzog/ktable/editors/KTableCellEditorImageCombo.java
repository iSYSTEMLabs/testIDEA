 ...
 */
public class KTableCellEditorImageCombo extends KTableCellEditor {
	private ImageCombo m_Combo;
...
//		m_Combo.setSelection(new Point(0, content.length()));
    ...
    private void setSelectionToClosestMatch(String content) {
        ...
        TableItem[] citems = m_Combo.getItems();
        String[] items = new String[citems.length];
        for (int i=0; i<citems.length; i++)
            items[i] = citems[i].getText().toLowerCase();
