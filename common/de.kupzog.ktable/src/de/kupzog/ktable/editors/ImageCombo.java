...
/**
 * Source downloaded at: <link>http://svn.bungtopia.com/public/trunk/image-combo/ImageCombo.java</link>
 */
...
public class ImageCombo extends Composite {
    ...
    public ImageCombo(Composite parent, int style, boolean showText) {
...
//        this.comboComposite.setLayout(new MigLayout("fill, insets 0 0 0 0"));
        this.comboComposite.setLayout(new FillLayout());

        this.imageLabel = new Label(this.comboComposite, SWT.NONE);
//        this.imageLabel.setLayoutData("growx");

        if (m_showText) {
            this.text = new Text(this.comboComposite, SWT.READ_ONLY);
            this.text.setLayoutData("growx");
        }
    ...
    public String getText() {
        ...
        if (m_showText) {
            ...
            final int idx = this.getSelectionIndex();
            final String idxStr = Integer.toString(idx);
            return idxStr;
        }
    }
