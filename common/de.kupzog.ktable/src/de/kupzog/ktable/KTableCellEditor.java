...
public abstract class KTableCellEditor {
		...
		if (m_Control == null) {
			...
			m_Control.addFocusListener(new FocusAdapter() {
				...
				public void focusLost(FocusEvent arg0) {
					if (m_Control != null && !m_Control.isDisposed()  &&  !isProposalPopupOpen()) {
						close(true);
					}
				}
			});
	...
	/**
	 * Override this method if proposals are supported
	 * @return
	 */
    ...
    /** Drops down combo or shows proposals for text items. */
