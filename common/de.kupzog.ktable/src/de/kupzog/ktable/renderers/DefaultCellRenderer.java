...
public class DefaultCellRenderer implements KTableCellRenderer {
    ...
    //  default colors:
    public static Color COLOR_TEXT = Display.getDefault().getSystemColor(SWT.COLOR_LIST_FOREGROUND);
    public static Color COLOR_EDITABLE_CELL = Display.getDefault().getSystemColor(SWT.COLOR_WHITE);
    
    public static Color COLOR_BACKGROUND = Display.getDefault().getSystemColor(SWT.COLOR_LIST_BACKGROUND);
    ...
    public static Color COLOR_DISABLED_BACKGROUND = SWTX.getColor(SWTX.COLOR_DISABLED_BACKGROUND);
    public static Color COLOR_DISABLED_FOREGROUND = SWTX.getColor(SWTX.COLOR_DISABLED_FOREGROUND);

    
    boolean m_isPushStyle = false;
    protected boolean m_isEnabled = true;  // by default component is enabled
    ...
    protected static final FixedCellRenderer m_FixedRenderer = new FixedCellRenderer(0, false);
