...
public abstract class KTableDefaultModel implements KTableModel {
    ...
    protected Hashtable<Integer, Integer> m_ColWidths = new Hashtable<>();
    private Hashtable<Integer, Integer> m_RowHeights = new Hashtable<>();
    ...
    public int getColumnWidth(int col) {
        Integer width =(Integer)m_ColWidths.get(Integer.valueOf(col));
        if (width==null) {
    ...
    public int getRowHeight(int row) {
    	 Integer height =(Integer)m_RowHeights.get(Integer.valueOf(row));
         if (height==null) {
        	 if (row==0) {
    ...
    public void setColumnWidth(int col, int value) {
        if (value<0) value=0;
        m_ColWidths.put(Integer.valueOf(col), Integer.valueOf(value));
    }
    ...
    public void setRowHeight(int row, int value) {
        if (value<2) value=2;        	
        m_RowHeights.put(Integer.valueOf(row), Integer.valueOf(value));
    }
