...
public class SWTX {
    ...
    public static final String COLOR_DISABLED_BACKGROUND = "disabledBkg";
    public static final String COLOR_DISABLED_FOREGROUND = "disabledFg";
    ...
    static {
        ...
        m_colorFactory.put(COLOR_DISABLED_BACKGROUND, new RGB(232,232,232));
        m_colorFactory.put(COLOR_DISABLED_FOREGROUND, new RGB(152,152,152));
    }
	...
	private static Map<String, Point> m_StringExtentCache = new TreeMap<>();
	...
	public static void drawTextImage(GC gc,
	                                 String text,
	                                 int textAlign,
	                                 Image image,
	                                 int imageAlign,
