...
public interface KTableCellRenderer {
    ...
    /**
     * Sets enabled status of the cell - renderer may adjust rendering based on 
     * this status. Usually disabled controls have gray background.
     * 
     * @param isEnabled true if table is enabled
     */
