 ...
 *  under the License. 
 *  
 *  MK note: Add org.hamcrest.library to si.isystem.uitest |
 *  MANIFEST.MF | Dependencies.
 */

import static org.eclipse.swtbot.swt.finder.matchers.WidgetMatcherFactory.withRegex;
import static org.hamcrest.Matchers.allOf;  // from 'org.hamcrest.library' 
...
/**
 * A helper to click context menus. This class was renamed when taken from 
 * Apache, to avoid confusion with class ContextMenuHelper from SWTBot. 
 * 
 * @author <a href="mailto:dev@directory.apache.org">Apache Directory Project</a>
 * @version $Rev$, $Date$
 */
public class ContextMenuForControl {
